...
namespace MMPEngine::Feature
{
	...
	protected:
		...
		virtual void UpdateMouseNormalizedPosition(const Core::Vector2Float&) = 0;
	...
	public:
		...
		Core::Vector2Float GetMouseNormalizedPosition() const;

	protected:
		void ClearInstantEvents() override;
		void ClearAll() override;
		void UpdateMouseNormalizedPosition(const Core::Vector2Float&) override;
